...
- Public documentation, architecture diagrams, product walkthrough, screenshot index, operations notes, and release notes.
...
- `v1.0.0` can be tagged after the release state is reviewed and CI is green.
